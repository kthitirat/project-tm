<template>
    <div class="w-full h-[550px] border border-slate-200 p-4 font-bold text-gray-700 hover:text-blue-600 hover:shadow-xl translate-all ease-in-out duration-400 cursor-pointer">
        ...
        <div class="mt-2">
            ...
            <div class="text-sm text-center mt-4 text-gray-700 font-normal">
                ...
                <p>เผยเพร่วันที่ {{ subject.published_at }}</p>
            </div>
        </div>
    </div>
</template>
